    ...
    setTimeout(() => {
      ...
      if (link.includes('#')) {
        ...
        if (path === '/' || path === '' || currentPath === '/') {
          // If we're going to home page or already on home, navigate first then scroll
          if (currentPath !== '/' && path === '/') {
            navigate('/');
            setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <div className="sm-logo" aria-label="Logo"></div>
        <button
          ref={toggleBtnRef}
          className="sm-toggle aeonik-mono"
        ...
        <div className="sm-panel-inner">
          ...
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Social links">
              <h3 className="sm-socials-title aeonik-mono">SOCIALS</h3>
                ...
                {socialItems.map((s, i) => (
                  <li key={s.label + i} className="sm-socials-item">
                    <a 
                      ...
                      className="sm-socials-link aeonik-mono"
                    >
                      {s.label.toUpperCase()}
                    </a>
                  </li>
